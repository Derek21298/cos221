...
// Added two height functions at end of file to obtain the height of a binary search tree
//
...
// This is a user function for the user to call
// Calls the worker function defined below
template <typename T>
int BST<T>::height() {
...
// Recursively calculate the height of a binary search tree
template <typename T>
int BST<T>::height(TreeNode<T>* node) {
	...
	// Calculate the height of the tree from the left and right 
